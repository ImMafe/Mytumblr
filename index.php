...
//create a pre vdefined username and password since we do not have database
$acc_username = "Mariafe";
$acc_password = "Amethyst02";
$acc_fullname = "Mafe R. Postrado";
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
                     ...
                     echo "<div class=alert alert-info' role='alert'> Thank You ... </div>";
		      				 ...
		      				 echo "<div class=alert alert-info' role='alert'> Please Login First. </div>";
  								 ...
  								 echo "<div class=alert alert-warning' role='alert'> You are still logged in. <a href='account.php'>Please click here </a> to proceed. </div>";
		      			}
